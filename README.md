...
**Real-time YOLO on the AMD Ryzen™ AI NPU: YOLOv8n, YOLO11n and YOLOv8n-pose run faster end to end than on AMD's own runtime, and more accurately, from a fraction of the install size.**
